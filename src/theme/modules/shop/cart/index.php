...
<section>
    <div class="container">
        ...
        <ul class="process-steps nav nav-justified">
            <li class="active">
                <a href="<?= \yii\helpers\Url::to(['/shop/cart/index']); ?>">1</a>
                <h5>Корзина</h5>
            </li>
            <li class="">
                <a href="<?= \yii\helpers\Url::to(['/shop/cart/checkout']); ?>">2</a>
                <h5>Оформление</h5>
            </li>
            <li class="">
                <a href="#">3</a>
                ...
                <div class="toggle-transparent toggle-bordered-full clearfix">
                    <div class="toggle active" style="display: block;">
                        <div class="toggle-content" style="display: block;">
                            ...
                            <span class="clearfix">
                                <span class="pull-right"><?= \Yii::$app->money->intlFormatter()->format(\Yii::$app->shop->cart->moneyNoDiscount); ?></span>
                                <strong class="pull-left">Итого:</strong>
                            </span>
                            <span class="clearfix">
                                <span class="pull-right"><?= \Yii::$app->money->intlFormatter()->format(\Yii::$app->shop->cart->moneyDiscount); ?></span>
                                <span class="pull-left">Скидка:</span>
                            </span>
                            <span class="clearfix">
                                <span class="pull-right"><?= \Yii::$app->money->intlFormatter()->format(\Yii::$app->shop->cart->moneyDelivery); ?></span>
                            ...
                            <span class="clearfix">
                                <span class="pull-right size-20"><?= \Yii::$app->money->intlFormatter()->format(\Yii::$app->shop->cart->money); ?></span>
                                <strong class="pull-left">ИТОГ:</strong>
                            </span>

                            <hr />

                            <a href="<?= \yii\helpers\Url::to(['/shop/cart/checkout']); ?>" class="btn btn-primary btn-lg btn-block size-15">
